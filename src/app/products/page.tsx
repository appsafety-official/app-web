...
const allProducts = [
  { id: "dummy-1", name: "Aluminized Fire Proximity Suit", category: "FIREFIGHTING", price: 2500000 },
  { id: "dummy-2", name: "Nomex Welding Jacket", category: "WELDING", price: 850000 },
  { id: "dummy-3", name: "Beekeeper Suit Ventilated", category: "HAZMAT", price: 1200000 },
  { id: "dummy-4", name: "Heavy Duty Impact Gloves", category: "HAND PROTECTION", price: 350000 },
];

const categories = ["ALL", "FIREFIGHTING", "WELDING", "HAZMAT", "HAND PROTECTION"];
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-xl text-sm leading-relaxed text-gray-400">
            Purpose-built protective apparel — search by name or category and
            sort by price or specification.
          </p>
        </div>
